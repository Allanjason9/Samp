...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-b from-green-50 to-white flex items-center justify-center">
      ...
      >
        <h2 className="text-2xl font-bold text-green-800 mb-6 text-center">Sign In</h2>
        ...
        <p className="mt-4 text-center text-sm text-green-600">
          Don't have an account? <Link href="/sign-up" className="font-medium text-green-800 hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  )
